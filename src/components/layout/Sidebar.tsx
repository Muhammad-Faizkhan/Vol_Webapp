...
export function Sidebar({ open = false, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-y-0 left-0 z-40 flex w-[280px] max-w-[85vw] shrink-0 flex-col bg-dak-cta transition-transform duration-200 ease-out dark:bg-dak-bg lg:w-[400px] lg:max-w-none lg:translate-x-0 ${
